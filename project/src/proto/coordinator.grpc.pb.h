...
class coordinatorService final {
 public:
  ...
  typedef WithStreamedUnaryMethod_sayHelloToCoordinator<WithStreamedUnaryMethod_checkalive<WithStreamedUnaryMethod_setParameter<WithStreamedUnaryMethod_reportCommitAbort<WithStreamedUnaryMethod_checkCommitAbort<WithStreamedUnaryMethod_uploadSetValue<WithStreamedUnaryMethod_uploadObjectValue<WithStreamedUnaryMethod_uploadSubsetValue<WithStreamedUnaryMethod_getStripe<WithStreamedUnaryMethod_getBlocks<WithStreamedUnaryMethod_getObject<WithStreamedUnaryMethod_getDegradedReadBlock<WithStreamedUnaryMethod_getRecovery<WithStreamedUnaryMethod_fullNodeRecovery<WithStreamedUnaryMethod_delByStripe<WithStreamedUnaryMethod_listStripes<WithStreamedUnaryMethod_decodeTest<Service > > > > > > > > > > > > > > > > > StreamedUnaryService;
